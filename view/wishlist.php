...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Wishlist - Kingstock</title>
    ...
    <body>
        ...
        <main>
            ...
            <!-- ====== wishlist-area-start=============================================== --> 
            <div class="wishlist-area d-none d-md-block mt-110">
                <div class="container">
                    <div class="row pb-100 cart-table">
                        <div class="col-xl-12  col-lg-12  col-md-12  col-sm-12 col-12">
                            <table class="table table-bordered">
                                ...
                                <tr class="text-center">
                                    <td>
                                        <a href="product-details.html" class="cart-img d-block">
                                            <img src="images/product/product10.jpg" alt="">
                                        </a>
                                    </td>
                                    <td>
                                        <a href="product-details.html" class="p-name primary-color">
                                            Black Fashion Zapda
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="cart.html" class="web-btn d-inline-block theme-bg border-theme02 white text-capitalize over-hidden position-relative pt-15 pb-15 pl-18 pr-18 mt-15">add to cart</a>
                                    </td>
                                    <td>
            ...
            <div class="wishlist-area d-block d-md-none mt-110">
                <div class="container">
                            ...
                            <div class="mobile-wishlist">
                                ...
                                <div class="wish-p d-sm-flex justify-content-between">
                                    <ul class="d-flex align-items-center"> 
                                        <li>
                                            <a href="product-details.html" class="p-img d-block mr-3">
                                                <img src="images/product/product10.jpg" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <h6><a class="d-block" href="product-details.html">Elegant wooden leg design Replica</a></h6>
                                            <span>$396.00</span>
                                        </li>
                                    </ul>
                                    <ul class="d-flex align-items-center">
                                        <li>
                                            <a href="cart.html" class="web-btn d-inline-block theme-bg border-theme02 white text-uppercase over-hidden position-relative pt-15 pb-15 pl-18 pr-18 mt-15">add to cart</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="wish-p d-sm-flex  justify-content-between">
                                    <ul class="d-flex align-items-center"> 
                                        ...
                                        <li>
                                            <h6><a class="d-block" href="product-details.html">Chair living room fiberglass</a></h6>
                                            <span>$246.00</span>
                                        </li>
                                    </ul>
                                    <ul class="d-flex align-items-center">
      ...
      <!-- back top -->
        <div class="scroll-up" id="scroll">
            <a href="#" class="h5-theme-bg2 white d-block text-center position-fixed mr-10">
                <span class="top">Back to To</span>
